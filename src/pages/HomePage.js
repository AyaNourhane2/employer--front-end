  ...
  return (
    <div className="home-page">
      <div className="welcome-section">
        <h1>Bienvenue dans le système de gestion hôtelière</h1>
        <p>Choisissez le rôle que vous souhaitez atteindre :</p>
      </div>

      <button className="show-roles-button" onClick={() => setShowRoles(!showRoles)}>
